...
class ClientSmokeStatePhase3Test {
    ...
    @Test
    @DisplayName("handleExit: source file contains exit-after-smoke config gating check")
    void handleExit_containsExitAfterSmokeCheck() throws Exception {
        ...
        String content = Files.readString(sourceFile);
        assertTrue(content.contains("ClientSmokeConfig.shouldExitAfterSmoke()"),
                "Source file must call ClientSmokeConfig.shouldExitAfterSmoke() — "
